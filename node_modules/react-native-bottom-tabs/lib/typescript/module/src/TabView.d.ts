...
declare const TabView: <Route extends BaseRoute>({ navigationState, renderScene, onIndexChange, onTabLongPress, rippleColor, tabBarActiveTintColor: activeTintColor, tabBarInactiveTintColor: inactiveTintColor, getBadge, getLazy, getLabelText, getIcon, getHidden, getActiveTintColor, getTestID, getRole, hapticFeedbackEnabled, labeled, getFreezeOnBlur, tabBar: renderCustomTabBar, tabBarStyle, tabLabelStyle, ...props }: Props<Route>) => import("react/jsx-runtime").JSX.Element;
