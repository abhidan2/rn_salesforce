...
#if !TARGET_OS_OSX
Class<RCTComponentViewProtocol> RNSBottomTabsCls(void) __attribute__((used)); // 3
Class<RCTComponentViewProtocol> RNSBottomTabsScreenCls(void) __attribute__((used)); // 3
Class<RCTComponentViewProtocol> RNSFullWindowOverlayCls(void) __attribute__((used)); // 3
Class<RCTComponentViewProtocol> RNSScreenStackHostCls(void) __attribute__((used)); // 3
Class<RCTComponentViewProtocol> RNSSplitViewHostCls(void) __attribute__((used)); // 3
Class<RCTComponentViewProtocol> RNSSplitViewScreenCls(void) __attribute__((used)); // 3
Class<RCTComponentViewProtocol> RNSStackScreenCls(void) __attribute__((used)); // 3
